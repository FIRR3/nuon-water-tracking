...
// Notification check-in times with generic messages
const NOTIFICATION_TIMES = [
  {
    hour: 10,
    minute: 0,
    title: "☀️ Morning reminder",
    body: "Good morning! Don't forget to start drinking water today. 💧",
  },
  {
    hour: 14,
    minute: 0,
    title: "💧 Afternoon reminder",
    body: "Halfway through the day — have you had enough water? Stay hydrated!",
  },
  {
    hour: 18,
    minute: 0,
    title: "🌙 Evening reminder",
    body: "Almost done for the day! Remember to hit your water goal before bed.",
  },
];
...
/**
 * Schedule daily notifications at three fixed times with generic messages.
 */
